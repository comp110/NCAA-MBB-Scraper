...
/**
 * This is a draft of what the students will do In the future we can maybe have
 * them instantiate matchups in their own main methods but this seemed simpler
 * for now
 **/
...
public class Matchup {
  ...
  public double calculateScore(Team team) { // moving weights to inside methods
                                            // will solve reflection problem for
                                            // now, easiest/quickest fix
  ...
  public double totalDoubleDoubles(Team team) {
    ...
    // }
    return 0;// totalDoubleDoubles * weight;
  }
  ...
  public double avgInchesOver6ft(Team team) {
    ...
    // }
    return 0;// (totalInches / (double) numPlayers) * weight;
  }
